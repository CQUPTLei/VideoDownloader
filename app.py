...
from logger import *
from get_video_format import get_video_formats


class VideoDownloaderApp:
    """A class used to represent a Video Downloader Application."""
    ...
    def download_thread(self):
        try:
            ...
            quality = audio if not video else video if not audio else video + '+' + audio
